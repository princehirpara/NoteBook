package com.princehirpara.notebook;
...
import com.princehirpara.notebook.auth.Login;
import com.princehirpara.notebook.auth.Register;
import com.princehirpara.notebook.model.Adapter;
import com.princehirpara.notebook.model.Note;
import com.princehirpara.notebook.note.AddNote;
import com.princehirpara.notebook.note.EditNote;
import com.princehirpara.notebook.note.NoteDetails;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user.isAnonymous()){
            ...
            username.setText("Temporarry User");
        }
        else {
    ...
    private void displayAlert() {
        AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Sync Note", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO: delete all the notescreated by the Annon user
